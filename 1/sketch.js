...
//框框們
let box = { x: 1365, y: 235, w: 260, h: 260 }; // 可移動框框
let originalBox = { x: 1365, y: 235, w: 260, h: 260 }; // 固定框框位置
let box2 = { x: 720, y: 50, w: 260, h: 260 }; // 可移動框框
let originalBox2 = { x: 720, y: 50, w: 260, h: 260 }; // 固定框框位置
let box3 = { x: 400, y: 320, w: 260, h: 260 }; // 可移動框框
let originalBox3 = { x: 400, y: 320, w: 260, h: 260 }; // 固定框框位置
//拖移yesORno
let dragging = false; 
let dragging2 = false; 
let dragging3 = false; 
...
let otherBoxes = [ // 定义其他框框的位置和大小
  { x: 370, y: 300, w: 260, h: 260 },
  { x: 720, y: 50, w: 260, h: 260 },
  { x: 320, y: 15, w: 260, h: 260 },
];
let otherBoxes2 = [ // 定义其他框框的位置和大小
  { x: 400, y: 320, w: 260, h: 260 },
  { x: 1350, y: 235, w: 260, h: 260 },
  { x: 390, y: 15, w: 260, h: 260 },
];
...
function preload() {
  // 预加载图片
  let L1 = loadImage("12.png");
  let L2 = loadImage("11.png");
  let L3 = loadImage("13.png");
  let L4 = loadImage("14.png");
  imgL1 = L1;
  imgL2 = L2;
  imgL3 = L3;
  imgL4 = L4;
