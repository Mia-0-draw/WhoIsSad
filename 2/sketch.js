...
//框框們
let box = { x: 920, y: 520, w: 260, h: 260 }; // 可移動框框
let originalBox = { x: 920, y: 520, w: 260, h: 260 }; // 固定框框位置
let box2 = { x: 300, y: 80, w: 260, h: 260 }; // 可移動框框
let originalBox2 = { x: 300, y: 80, w: 260, h: 260 }; // 固定框框位置
let box3 = { x: 300, y: 180, w: 260, h: 260 }; // 可移動框框
let originalBox3 = { x: 300, y: 180, w: 260, h: 260 }; // 固定框框位置
//拖移yesORno
let dragging = false; 
let dragging2 = false; 
let dragging3 = false; 
...
let otherBoxes = [ // 定义其他框框的位置和大小
  { x: 640, y: 390, w: 260, h: 260 },
  { x: 510, y: 120, w: 260, h: 260 },
  { x: 1280, y: 15, w: 260, h: 260 },
];
let otherBoxes2 = [ // 定义其他框框的位置和大小
  { x: 650, y: 420, w: 260, h: 260 },
  { x: 920, y: 520, w: 260, h: 260 },
  { x: 1220, y: 250, w: 260, h: 260 },
];
let otherBoxes3 = [ // 定义其他框框的位置和大小
  { x: 1220, y: 250, w: 260, h: 260 },
  { x: 920, y: 520, w: 260, h: 260 },
  { x: 600, y: 100, w: 260, h: 260 },
];
...
function preload() {
  // 预加载图片
  let L1 = loadImage("22.png");
  let L2 = loadImage("21.png");
  let L3 = loadImage("23.png");
  let L4 = loadImage("24.png");
  imgL1 = L1;
  imgL2 = L2;
  imgL3 = L3;
  imgL4 = L4;
 ...
 if (stage==3){
  ...
  if (inRange3==false){
    otherBoxes3 = [ // 定义其他框框的位置和大小
      { x: 1220, y: 230, w: 260, h: 260 },
      { x: 860, y: 320, w: 260, h: 260 },
      { x: 570, y: 40, w: 260, h: 260 },
      { x: 300, y: 80, w: 260, h: 260 }
    ];
    originalBox3 = { x: 300, y: 80, w: 260, h: 260 };
  }else{
    otherBoxes3 = [ // 定义其他框框的位置和大小
      { x: 1220, y: 230, w: 260, h: 260 },
      { x: 860, y: 320, w: 260, h: 260 },
      { x: 590, y: 100, w: 260, h: 260 },
    ];
    originalBox3 = { x: 300, y: 180, w: 260, h: 260 };
  }
}
